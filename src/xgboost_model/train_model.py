...
from xgboost_model.data_management import load_dataset, save_model
from xgboost_model.preprocessing import drop_nas, rename_cols, label_encoding
...
def run_training():
    ...
    X_train, X_test, y_train, y_test = train_test_split(df[config.KEEP_FEATURES]
                                                    , df[config.target]
